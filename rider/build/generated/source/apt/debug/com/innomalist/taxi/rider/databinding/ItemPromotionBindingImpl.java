...
public class ItemPromotionBindingImpl extends ItemPromotionBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.innomalist.taxi.common.models.Promotion) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.innomalist.taxi.common.models.Promotion Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.innomalist.taxi.common.models.Media itemMedia = null;
        com.innomalist.taxi.common.models.Promotion item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.innomalist.taxi.common.utils.DataBinder.setMedia(this.imgThumb, itemMedia);

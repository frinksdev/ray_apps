package com.ray.taxi.rider.activities.addresses;
...
import com.ray.taxi.rider.activities.addresses.adapters.AddressesRecyclerViewAdapter;
import com.ray.taxi.rider.activities.addresses.fragments.EditAddressDialog;
...
public class AddressesActivity extends BaseActivity implements EditAddressDialog.onEditAddressInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.recyclerView.setStateDisplay(EmptyStateRecyclerView.STATE_EMPTY, new ImageTextStateDisplay(this, com.innomalist.taxi.common.R.drawable.empty_state, "Oops!", "Nothing to show here :("));

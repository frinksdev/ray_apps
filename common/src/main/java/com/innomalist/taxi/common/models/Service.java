...
public class Service implements Serializable {
	...
	public boolean isCanUseConfirmationCode() {
		return canUseConfirmationCode == 1;
	}

	public void setCanUseConfirmationCode(boolean canUseConfirmationCode) {
		this.canUseConfirmationCode = canUseConfirmationCode ? 1 : 0;
	}
}
...
public class ItemTransactionBindingImpl extends ItemTransactionBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.innomalist.taxi.common.models.Transaction) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.innomalist.taxi.common.models.Transaction Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.innomalist.taxi.common.models.Transaction item = mItem;

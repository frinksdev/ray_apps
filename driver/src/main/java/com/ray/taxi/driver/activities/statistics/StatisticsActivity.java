package com.ray.taxi.driver.activities.statistics;
...
import com.ray.taxi.driver.activities.statistics.charts.IncomeLineChart;
...
import com.ray.taxi.driver.models.Report;
        ...
        if (event.reports != null && event.reports.size() != 0) {
            ...
            for (Report report : event.reports) {
                ...
                try {
                    ...
                    if (getResources().getBoolean(com.innomalist.taxi.common.R.bool.use_date_converter)) {

package com.ray.taxi.driver.services;
...
import com.ray.taxi.driver.events.ChangeHeaderImageEvent;
...
import com.ray.taxi.driver.events.GetStatisticsEvent;
import com.ray.taxi.driver.events.GetStatisticsResultEvent;
...
import com.ray.taxi.driver.events.PaymentRequestEvent;
import com.ray.taxi.driver.events.PaymentRequestResultEvent;
...
public class DriverService extends Service {
        ...
        try {
            ...
            socket.on(Socket.EVENT_CONNECT, args -> {
                ...
                eventBus.post(new SocketConnectionEvent(Socket.EVENT_CONNECT));
                    ...
                    .on("requestReceived", args -> eventBus.post(new RequestReceivedEvent(args)))
    ...
    public void FinishTravel(final ServiceFinishEvent event) {
        ...
        socket.emit("finishedTaxi", event.finishService.toJson(), (Ack) args -> eventBus.post(new ServiceFinishResultEvent(args)));
    }
    ...
    public void startTaxi(ServiceStartEvent event) {
        socket.emit("startTravel", (Ack) args -> eventBus.post(new ServiceStartResultEvent(args)));
    }
